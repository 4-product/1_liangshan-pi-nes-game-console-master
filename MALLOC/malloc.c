...
//内存池(32字节对齐)
__align(32) u8 mem1base[MEM1_MAX_SIZE] __attribute__((at(0X20020000)));													//内部SRAM内存池
...
//内存管理表
u32 mem1mapbase[MEM1_ALLOC_TABLE_SIZE] __attribute__((at(0X20020000+MEM1_MAX_SIZE)));													//内部SRAM内存池MAP
